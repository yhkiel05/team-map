...
function MapView() {
    ...
    // Add loading and error states to the MapView return
    if (loading) {
        return (
            <div className="h-screen flex items-center justify-center bg-gray-100">
                <div className="text-center">
                    <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-blue-600 mx-auto mb-4"></div>
                    <h2 className="text-xl font-semibold text-gray-700">Loading room...</h2>
                    <p className="text-gray-500">Please wait while we load your collaborative map</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="h-screen flex items-center justify-center bg-gray-100">
                <div className="text-center max-w-md mx-auto p-8">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">Room Not Found</h2>
